package net.droidfx01.javaFxDemo;

import java.io.IOException;

import net.droidfx01.javaFxDemo.model.Person;
import net.droidfx01.javaFxDemo.view.PersonOverViewController;
...
public class MainApp extends Application {
	...
	public MainApp() {
		//Add sample data
		personData.add(new Person("Jon", "Fox"));
		personData.add(new Person("Jim", "Muller"));
